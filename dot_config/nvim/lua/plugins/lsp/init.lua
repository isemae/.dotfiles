return {
  { -- LSP
    ...
    config = function(_, opts)
      ...
      local servers = {}
      local lsp_servers_path = vim.fn.stdpath("config") .. "/lua/plugins/lsp/servers"
      ...
      require("mason-lspconfig").setup({
        ...
        handlers = {
          function(server_name)
            ...
            server_options.handlers = vim.tbl_deep_extend("force", {}, common_handlers, server_options.handlers or {})
